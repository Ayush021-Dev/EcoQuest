...
var waypoints = [
	Vector2(3385.0, 1437.0),   # Point 1 - grass area
	Vector2(3257.0,796.0 ),   # Point 2 - grass area  
	Vector2(3058.0, 987.0),   # Point 3 - grass area
	Vector2(3278.0, 971.0),   # Point 4 - grass area
